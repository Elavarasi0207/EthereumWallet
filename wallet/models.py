...
class Details(models.Model):
    key_ref_id = models.CharField(max_length=500)
    username = models.CharField(max_length=500)
    email = models.CharField(max_length=500)
    private_key = models.CharField(max_length=500)
    asset_type = models.CharField(max_length=500, default="Ether")
    ...
    #private_key_retrieved = models.CharField(max_length=500)
